/**
 * Ask User Tool - Unified tool for asking single or multiple questions
 *
 * Copied `questionnaire.ts` from: https://github.com/earendil-works/pi/tree/main/packages/coding-agent/examples
 *
...
export default function questionnaire(pi: ExtensionAPI) {
	pi.registerTool({
		name: "ask_user",
		label: "Ask user",
		description: "Ask the user one or more questions. Use in lieu of plain-text questions that require a response, such as: clarifying requirements, getting preferences, or confirming decisions. For single questions, shows a simple option list. For multiple questions, shows a tab-based interface.",
